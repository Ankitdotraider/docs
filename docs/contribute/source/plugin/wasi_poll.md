...
To enable the WasmEdge WASI-Poll plug-in, developers need to [build WasmEdge from source](https://github.com/WasmEdge/docs/blob/main/docs/contribute/source/os/linux.md) with the cmake option `-DWASMEDGE_PLUGIN_WASI_POLL=ON`.

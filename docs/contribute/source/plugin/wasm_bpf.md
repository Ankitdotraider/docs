...
To enable the Wasm-BPF plug-in, developers need to [build WasmEdge on Linux](https://github.com/WasmEdge/docs/blob/main/docs/contribute/source/os/linux.md) with the CMake option `-DWASMEDGE_PLUGIN_WASM_BPF=ON`.
